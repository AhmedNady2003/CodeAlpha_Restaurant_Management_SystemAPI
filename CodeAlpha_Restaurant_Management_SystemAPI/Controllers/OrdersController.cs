...
namespace CodeAlpha_Restaurant_Management_SystemAPI.Controllers
{
    ...
    public class OrdersController : ControllerBase
    {
        ...
        {
            return await _context.Orders.Include(o => o.OrderMenuItems).ToListAsync();
        }
        ...
        {
            var order = await _context.Orders.Include(o => o.OrderMenuItems).FirstOrDefaultAsync(o => o.OrderId == id);
